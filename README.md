...
- `pattern(threshold: "description", css)` → defines a fuzzy-matched style
- Bare phrases in your stylesheet get matched against the closest pattern description and replaced with its CSS
```css
pattern(
0.5:
"Hello World card",
