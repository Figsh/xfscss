...
function execObj(css){
  return css.replace(/exec\.obj\.block\([^\)\n]*\)\;?/g, "");
    ...
    replaceRe, procExt, procVar,procFun, procFunObj, procArr, procEv, procRan, transformCssValues, procNum, vfc, processNLPCSS, getSimilarity, resolveMatches, extractMatchCalls, applyFscssTransformations,procExC, procCnt, procDef, procChe, procInline ,execObj
    } 
