...
function execObj(css){
  return css.replace(/exec\.obj\.block\([^\)\n]*\)\;?/g, "");
    ...
    replaceRe, procExt, procVar,procFun, procFunObj, procArr, procEv, procRan, transformCssValues, procNum, vfc, processNLPCSS, applyFscssTransformations,procExC, procCnt, procDef, procChe, execObj
    } 
